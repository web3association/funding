...
The ownership of ideas can heavily influence how they get governed, executed, changed and supported by a community over time.
...
* **Increasing contributor flexibility** - Contributing towards a more collaborative effort to execute different shared ideas could help with boosting individual motivation and morale due to a shared feeling of ownership and achievement in creating impactful outcomes. The flexibility for contributors to support the execution of one or many shared ideas could also help with enabling them to more quickly generate impactful outcomes.
