...
* **Verifiable information** - Providing that these knowledge systems are open source, easily accessible and verifiable the members of an ecosystem will be able to verify that the information coming out of these systems is correct and trustworthy.
* **Determining fact from opinion** - One important task for knowledge systems is keeping the distinction between fact and opinion clear to users of that system. Factual areas of information like on-chain data or statistics can all have their sources made public and verifiable. Achieving this means voters will have an enhanced ability to determine which pieces of information are the most important and useful when making future decisions.
