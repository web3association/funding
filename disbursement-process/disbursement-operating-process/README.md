...
The [general purpose operating process](http://127.0.0.1:5000/s/qIN4B3DGHPqKOl7e6VuV/web-3-treasuries/operating-process) can be applied to treasury disbursement. Applying this process can help with thinking about how each of the processes involved in disbursement can be improved and how those processes play an important role in helping an ecosystem achieve its priorities and overall mission.
...
* **Nation states** - The execution for treasury disbursement for nation states can often mean distributing a certain budget to different national departments, this funding then in turn gets used to pay for employees and operational costs. The nation state treasury could influence or be responsible for new policies that change what treasury income is received through taxation and also influence how funds are disbursed. Once any of these changes are made there will be more data made available over time that help with determining how those changes are performing against the priorities for the treasury. Other areas around data, insights and citizen sentiment could also become available and provide more information about the current stability and growth of the economy due to the changes made.
* **Corporations** - For corporations, treasury assets are often disbursed to employees or contractors. With this disbursement structure already in place the teams responsible for executing selected ideas can do so as soon as any ideas are selected. Ideas that require new teams to form before they can be executed could be achieved through hiring efforts. In terms of measuring outcomes corporations will often be more focussed on the service or product performance metrics which give more indication on how an executed idea is performing financially and in terms of satisfaction with their customers.
